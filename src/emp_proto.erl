...
encode_error_code(invalid_compression_scheme) -> 3;
encode_error_code(invalid_compressed_data) -> 4.
...
decode_error_code(3) -> invalid_compression_scheme;
decode_error_code(4) -> invalid_compressed_data;
